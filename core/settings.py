...
SECRET_KEY = 'django-insecure-4^msd-h0l6n^(p680$6sogj94(zpq8gt)$7o@zz82b49ezajqx'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "SaahYaatri",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "SaahYaatri",
    ...
    "usermenu_links": [
        {"name": "Support", "url": "https://github.com/RoshanGurung-Eng", "new_window": True},
        {"model": "auth.user"}
    ],
